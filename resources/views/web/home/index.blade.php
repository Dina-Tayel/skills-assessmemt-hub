   ...
   @section('content')
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url({{ asset('uploads/img/home-background.jpg') }})"></div>
			<!-- /Backgound Image -->
			...
			<div class="home-wrapper">
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							<h1 class="white-text"> {{ __('web.TheroTitle')}}</h1>
							<p class="lead white-text">{{ __('web.TheroDescription')}}</p>
							<a class="main-button icon-button" href="#">{{ __('web.getStartBtn') }}</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="contact-cta" class="section">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url({{ asset('uploads/img/cta.jpg') }})"></div>
			<!-- Backgound Image -->
